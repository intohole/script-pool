...
# weibo api访问配置
APP_KEY = '251583918'      # app key
APP_SECRET = '150f5d4963fafc00a1f6222112204516'   # app secret
CALLBACK_URL = 'http://www.hutouxie.info' # callback url 授权回调页,与OAuth2.0 授权设置的一致
USERID = 'lixuze2005@sina.com'       # 微博用户名                     
USERPASSWD = '9956321'   # 用户密码
